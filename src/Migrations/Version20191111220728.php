 ...
 */
final class Version20191111220728 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recipe_ingredient ADD recipe_id INT NOT NULL, ADD ingredient_id INT NOT NULL, ADD measure_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recipe_ingredient DROP recipe_id, DROP ingredient_id, DROP measure_id');
    }
}
